...
import com.eliabdiel.springboot.bankingportal.bankingportal.exception.AccountDoesNotExistException;
import com.eliabdiel.springboot.bankingportal.bankingportal.exception.InvalidOtpException;
import com.eliabdiel.springboot.bankingportal.bankingportal.exception.OtpRetryLimitExceededException;
import com.eliabdiel.springboot.bankingportal.bankingportal.repository.OtpInfoRepository;
...
public class OtpServiceImpl implements OtpService{
    ...
    private void validateOtpWithinRetryLimit(OtpInfo otpInfo) {
        ...
        throw new OtpRetryLimitExceededException(String.format(ApiMessages.OTP_GENERATION_LIMIT_EXCEEDED.getMessage(), waitingMinutes));
    }
