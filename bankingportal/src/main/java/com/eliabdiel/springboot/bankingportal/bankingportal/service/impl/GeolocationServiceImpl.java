...
import com.eliabdiel.springboot.bankingportal.bankingportal.exception.GeolocationException;
    ...
    public CompletableFuture<GeolocationResponse> getGeolocation(String ip) {
        ...
        try {
            ...
            if (response == null) {
                ...
                future.completeExceptionally(new GeolocationException("Failed to get geolocation for IP: " + ip));
            } else {
